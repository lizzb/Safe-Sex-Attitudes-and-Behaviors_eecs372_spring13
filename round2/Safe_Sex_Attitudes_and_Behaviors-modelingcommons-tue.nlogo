...
;repeat 15 [ layout-spring turtles links 0.3 (world-width / (sqrt count turtles)) 1 ] ;; was 10
                 
;; If you want your linked turtles to move spatially closer to each other,
;; call this, either 10-15 times on setup, or each tick
...
;; AIDS model sets these variables with sliders,
;; but for simplicity, use predetermined values

;; Individual values per turtle are still set
;; using a random value following a normal distribution
...
to go
  ...
  ask turtles
  [
    talk-to-peers ;; talk to both friends and sexual partners......
...
;;
;; SELECT PROCEDURE
;; User chooses an agent to infect
;; 
to select
  let picked? false
  if mouse-down?
